...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-15 04:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/fbc99a48-3a5c-45c9-b804-7e40aa5f285c.git
$ cd fbc99a48-3a5c-45c9-b804-7e40aa5f285c
```
